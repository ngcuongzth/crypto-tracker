    ...
    return (
        <section className='xl:w-4/12 text-sm'>
            ...
            <div className='flex  mb-2 flex-col gap-1 s:flex-row s:items-center '>
                ...
                <Link className='tag w-max opacity-80' to={links.homepage[0]}>
                    {links.homepage[0].length > 40 ?
                        links.homepage[0].substr(0, 40) + " " :
                        links.homepage[0]
                    }
                </Link>
            </div>
            <div className='flex  mb-2 flex-col gap-1 s:flex-row s:items-center'>
                ...
                <div className='flex items-center gap-1 '>
                    <Link className='tag w-max  opacity-80' to={links.blockchain_site[0]}>
                        {links.blockchain_site[0].length > 40 ?
            ...
            <div className='flex  mb-2 flex-col gap-1 s:flex-row s:items-center'>
                ...
                <div className='flex gap-1'>
                    <Link to="/" className='tag w-max flex items-center gap-1  opacity-80'>
